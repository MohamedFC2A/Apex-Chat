...
function buildSynthesisPrompt(
  ...
  return `You are the Supreme Synthesis Engine of the Deca-Core Cognitive Architecture.
Your job is to read the outputs from all 10 specialized cognitive agents and generate the ultimate, most comprehensive, and complete response to the user's query.

ORIGINAL QUERY: "${originalQuery}"

Here are the responses generated by the 10 cognitive agents:
...
2. Synthesize the insights from ALL 10 agents above into a single, cohesive, fully integrated.
