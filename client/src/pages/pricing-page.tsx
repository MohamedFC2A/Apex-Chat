...
const tiers = [
    ...
    },
    {
        ...
        features: [
            "🧠 APEX UNBOUND — God Mode AI (Uncensored)",
            "⚡ 10-Agent Deca-Core Cognitive Architecture",
            "🔮 Hybrid DeepSeek Neural Fusion",
            "🎯 Judge Model Consensus Scoring",
            "🌀 Chain-of-Density Thought Synthesis",
            "📊 99.9% Accuracy on Complex Tasks",
            "🚀 Priority Access to All Future Models",
