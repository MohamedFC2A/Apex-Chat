...
- Dark/glassmorphic aesthetic: Use deep backgrounds with low saturation, glowing borders (e.g., border: 1px solid rgba(255, 255, 255, 0.08)), backdrop-filter: blur(20px), and subtle box-shadows (e.g., 0 8px 32px 0 rgba(0, 0, 0, 0.4)). Use inset shadows for premium depth.
...
6. Write comprehensive rules for every element in the GLOBAL SELECTOR MAP.
