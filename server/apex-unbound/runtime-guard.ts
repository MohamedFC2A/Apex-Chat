...
function buildDeterministicRuntime(spec: SystemSpec, selectorMap: GlobalSelectorMap): string {
  ...
  return `/* Apex Coder deterministic runtime guard.
...
document.addEventListener("DOMContentLoaded", function apexCoderRuntimeGuard() {
  "use strict";
...
function buildDeterministicCss(spec: SystemSpec): string {
  ...
  return `/* Apex Coder deterministic CSS guard.
