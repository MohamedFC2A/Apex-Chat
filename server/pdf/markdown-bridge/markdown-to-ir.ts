/**
 * ╔══════════════════════════════════════════════════════════════════════════════╗
 * ║  APEX PDF — Markdown to IR Converter v4.0                                 ║
 * ╚══════════════════════════════════════════════════════════════════════════════╝
 */

import type { PDFDocument, PDFSection, PDFDocumentLanguage } from "../../../shared/pdf/types.js";
import { detectPdfLanguage } from "../intent/language-detector.js";
...
export function conversationToPdfDocument(
  ...
  messages.forEach((message) => {
    const label =
      message.role === "user"
        ? isArabicConversation ? "رسالة المستخدم" : "User Message"
        : isArabicConversation ? "رد المساعد" : "Assistant Response";
